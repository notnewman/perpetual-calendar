...
<meta content="NosyMotorist" name="author">
</head>
...
while ($row <= 6){
	...
	echo"</table>";
?>
<span id='fb'></span></form><script type="text/javascript" src="./pcalendar.js"></script>
<br><br></td></tr></table>Select any month in a year between 1753 and 3000<br><br><small>Why 1753?&nbsp;&nbsp;This is the first year of the calendar we are familiar with; the previous year was shortened by 11 days to compensate for drift between the actual orbital year and that as calculated.</small></td><td style="width: 605px; background-color: silver; vertical-align: top;"><br>
